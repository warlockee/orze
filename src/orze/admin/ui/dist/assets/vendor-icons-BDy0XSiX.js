 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ue=x.forwardRef(({color:c="currentColor",size:p=24,strokeWidth:d=2,absoluteStrokeWidth:k,className:_="",children:v,iconNode:C,...M},b)=>x.createElement("svg",{ref:b,...oe,width:p,height:p,stroke:c,strokeWidth:k?Number(d)*24/Number(p):d,className:X("lucide",_),...M},[...C.map(([R,q])=>x.createElement(R,q)),...Array.isArray(v)?v:[v]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a=(c,p)=>{const d=x.forwardRef(({className:k,..._},v)=>x.createElement(ue,{ref:v,iconNode:p,className:X(`lucide-${ne(c)}`,k),..._}));return d.displayName=`${c}`,d};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
